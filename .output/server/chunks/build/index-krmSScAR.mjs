...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-page" }, _attrs))} data-v-98961f6f><div class="page-head" data-v-98961f6f>`);
      ...
      _push(`</div><section class="editor-shell" data-v-98961f6f><div class="form-stack" data-v-98961f6f>`);
      _push(ssrRenderComponent(_component_AdminPanel, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="ghost-btn" type="button" data-v-98961f6f${_scopeId}>Refresh list</button>`);
            if (unref(pending)) {
              _push2(`<p class="muted" data-v-98961f6f${_scopeId}>Reading content/projects...</p>`);
            } else {
              _push2(`<div class="content-list" data-v-98961f6f${_scopeId}><!--[-->`);
              ssrRenderList(unref(projects), (project) => {
                _push2(`<article class="content-row" data-v-98961f6f${_scopeId}><div data-v-98961f6f${_scopeId}><p class="eyebrow" data-v-98961f6f${_scopeId}>${ssrInterpolate(project.lab || "unassigned")} / ${ssrInterpolate(project.status)}</p><h3 data-v-98961f6f${_scopeId}>${ssrInterpolate(project.title)}</h3><p data-v-98961f6f${_scopeId}>${ssrInterpolate(project.description || project.filePath)}</p></div><div class="row-actions" data-v-98961f6f${_scopeId}>`);
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  class: "mini-link",
      ...
      _push(`</div><aside class="metadata-panel" data-v-98961f6f>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-98961f6f"]]);

export { index as default };
//# sourceMappingURL=index-krmSScAR.mjs.map
